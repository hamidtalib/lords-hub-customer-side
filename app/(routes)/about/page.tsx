...
// CountUp component
const CountUp = ({ end }: { end: string | number }) => {
...
export default function AboutPage() {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <motion.section
        className="border-b-4 border-amber-500/30 px-4 py-16 sm:px-6 lg:px-8 section-gradient text-center"
        variants={fadeInUp}
      >
        ...
        <div className="mx-auto max-w-6xl grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat, i) => {
            ...
            return (
              <motion.div
                key={stat.label}
                className="card-lift border-2 border-amber-500/30 group bg-gradient-to-br from-slate-800/90 to-slate-700/90 shadow-2xl backdrop-blur-sm"
              ...
              >
                <CardContent className="pt-6 text-center">
                  <Icon className="h-8 w-8 text-blue-400 mb-4 group-hover:scale-110 transition-transform duration-300 mx-auto" />
      ...
      {/* Journey Section */}
      <motion.section
        className="border-t-4 border-amber-500/30 px-4 py-16 sm:px-6 lg:px-8 section-gradient"
        variants={fadeInUp}
      >
      ...
      {/* CTA Section */}
      <motion.section
        className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8 section-gradient text-center"
        variants={fadeInUp}
      >
