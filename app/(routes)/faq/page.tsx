...
export default function FAQPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <section className="px-4 py-8 sm:px-6 lg:px-8 border-b-4 border-amber-500/30">
        <div className="mx-auto max-w-6xl">
          ...
          {filteredFaqs.length > 0 ? (
            <Accordion type="single" collapsible className="w-full">
              {filteredFaqs.map((faq, idx) => (
                ...
                >
                  <AccordionTrigger className="hover:text-amber-400 transition-colors duration-300 text-left py-4 font-bold text-base text-slate-200">
                    {faq.question}
                  </AccordionTrigger>
            ...
            <Card className="border-2 border-amber-500/30 text-center py-16 bg-gradient-to-br from-slate-800/90 to-slate-700/90 shadow-2xl backdrop-blur-sm">
              <CardContent>
                ...
                <Button
                  variant="outline"
                  className="border-2 border-amber-500/50 hover:border-amber-400 hover:bg-amber-500/20 text-white transition-all duration-300 font-semibold"
