            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {bots.map((item) => (
                  <div
                    key={item.id}
                    className="bg-gradient-to-br from-slate-800/90 to-slate-700/90 rounded-xl border-2 border-purple-500/30 overflow-hidden hover:border-purple-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/20 p-6 flex flex-col h-full"
                  >
                    ...
                    <div className="pt-4 border-t border-slate-700 mt-auto">
                      ...
                      <Link href={`/chat?source=kvk-bots&productId=${item.productId}`}>
