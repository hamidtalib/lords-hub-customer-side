  ...
  const tableColumns = useMemo<TableColumn<MarketplaceProduct>[]>(
    () => [
      ...
      },
      {
        ...
        label: "Tier",
        render: (item) => (
          <span className="inline-flex rounded-full border border-purple-400/40 px-3 py-1 text-xs font-semibold text-purple-200 whitespace-nowrap">
            {item.tier}
          </span>
        ),
      },
      ...
      >
        <div className="mx-auto max-w-6xl text-center">
          <div className="flex flex-col items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <Radar className="h-10 w-10 sm:h-12 sm:w-12 lg:h-14 lg:w-14 text-purple-400" />
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black gradient-text text-center">Tracker Bots</h1>
          </div>
