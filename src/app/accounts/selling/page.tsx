    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      >
        <div className="flex flex-col items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          <DollarSign className="h-10 w-10 sm:h-12 sm:w-12 lg:h-14 lg:w-14 text-amber-400" />
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black gradient-text text-center">Sell Your Account</h1>
        </div>
      ...
      {/* Main Content */}
      <section className="px-3 sm:px-4 py-8 sm:py-12 lg:py-16 lg:px-8 fade-up">
        <div className="mx-auto max-w-4xl">
          <Card className="border-2 border-amber-500/30 bg-gradient-to-br from-slate-800/90 to-slate-700/90 shadow-2xl">
            <CardHeader className="p-4 sm:p-6">
              <CardTitle className="text-2xl sm:text-3xl font-black text-white text-center">
            ...
            <CardContent className="space-y-6 sm:space-y-8 p-4 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <div className="bg-slate-800/50 rounded-lg p-4 sm:p-6 text-center border border-slate-700">
                  <DollarSign className="w-10 h-10 sm:w-12 sm:h-12 text-amber-400 mx-auto mb-2 sm:mb-3" />
                  <h3 className="font-bold text-white mb-1 sm:mb-2 text-sm sm:text-base">Best Prices</h3>
                  <p className="text-xs sm:text-sm text-slate-400">
                    Get competitive offers for your account
                  </p>
                </div>
                <div className="bg-slate-800/50 rounded-lg p-4 sm:p-6 text-center border border-slate-700">
                  <Zap className="w-10 h-10 sm:w-12 sm:h-12 text-amber-400 mx-auto mb-2 sm:mb-3" />
                  <h3 className="font-bold text-white mb-1 sm:mb-2 text-sm sm:text-base">Fast Process</h3>
                  <p className="text-xs sm:text-sm text-slate-400">
                    Quick evaluation and payment
                  </p>
                </div>
                <div className="bg-slate-800/50 rounded-lg p-4 sm:p-6 text-center border border-slate-700">
                  <Shield className="w-10 h-10 sm:w-12 sm:h-12 text-amber-400 mx-auto mb-2 sm:mb-3" />
                  <h3 className="font-bold text-white mb-1 sm:mb-2 text-sm sm:text-base">Secure Transfer</h3>
                  <p className="text-xs sm:text-sm text-slate-400">
              ...
              <div className="text-center">
                <Link href="/chat?inquiry=sell-account" className="block">
                  <Button className="w-full sm:w-auto bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-700 hover:to-amber-600 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 text-base sm:text-lg">
                    ...
                    <span className="sm:hidden">Chat to Sell Account</span>
                  </Button>
                </Link>
