        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <Link href="#" className="text-slate-400 hover:text-amber-400 transition-all duration-300 hover:scale-125 transform">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {['Accounts', 'Gems', 'Diamonds', 'Bot Services'].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-slate-300 hover:text-amber-400 transition-all duration-300 hover:translate-x-1 transform inline-block font-semibold">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-sm text-slate-300 mb-4 font-semibold">Get updates on new accounts and deals.</p>
            <div className="flex gap-2">
              <Input 
                type="email" 
                placeholder="Email" 
                className="border-2 border-amber-500/50 focus:border-amber-400 bg-slate-700/50 text-white placeholder:text-slate-400 text-sm font-semibold transition-all duration-300"
              />
